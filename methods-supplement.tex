...
The MCMC sampler was run for a total of 500,000 iterations,
...
summary statistics of the resulting posterior distributions are given in table~\ref{tab:posterior_distrns}.
...
If we remove this effect, 
by looking at the correlation between the traits on a hypothetical branch on which body length does not change,
we get the following posterior mean correlation matrix:
