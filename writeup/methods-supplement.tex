...
*Correspondence: \email{matthew.dean$@$usc.edu}
\end{center}
...
All original data and analytical code have been deposited in the Dryad Digital Repository \\
(\url{http://dx.doi.org/10.5061/dryad.ss7kp}).
...
All bones were scanned with a NextEngine 3-dimensional Laser Scanner, returning tens of thousands of $x,y,z$ points per bone.  A pipeline was developed to sub-sample 962 evenly spaced and ordered points.  The pipeline is graphically illustrated for pelvic bones (Fig. S2) and ribs (Fig. S3) separately.  All original laser scans and the associated code for imposing landmarks has been made available on the Dryad Digital Repository (\url{http://dx.doi.org/10.5061/dryad.ss7kp}). 
...
\end{center}
\caption{
\textbf{The regression of maximal recorded testis size onto maximal recorded body length.} 
...
All code is available at \url{http://dx.doi.org/10.5061/dryad.ss7kp}.
}
\end{figure}
% \end{landscape}
